...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => 'LoreSecurity <small>by Mustafa Halit Özer</small>',
      'framework_class'         => '',
    ...
    public function add_admin_footer_text() {
      $default = ' <a href="https://www.linkedin.com/in/mustafa-halit-ozer/" target="_blank">LinkedIn</a>';
      ...
      echo '<div class="csf csf-options'. esc_attr( $theme . $class . $wrapper_class ) .'" data-slug="'. esc_attr( $this->args['menu_slug'] ) .'" data-unique="'. esc_attr( $this->unique ) .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo ( $has_nav && $this->args['show_all_options'] ) ? '<div class="csf-expand-all" title="'. esc_html__( 'Tüm Ayarları Göster', 'csf' ) .'"><i class="fas fa-outdent"></i></div>' : '';

            echo ( $this->args['show_search'] ) ? '<div class="csf-search"><input type="text" name="csf-search" placeholder="'. esc_html__( 'Ayar Ara(s)', 'csf' ) .'" autocomplete="off" /></div>' : '';

            echo '<div class="csf-buttons">';
            echo '<input type="submit" name="'. esc_attr( $this->unique ) .'[_nonce][save]" class="button button-primary csf-top-save csf-save'. esc_attr( $ajax_class ) .'" value="'. esc_html__( 'Kaydet', 'csf' ) .'" data-save="'. esc_html__( 'Kaydediliyor...', 'csf' ) .'">';
            echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Bölümü Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Bu bölümü sıfırlamak istediğinizden emin misiniz?', 'csf' ) .'">' : '';
            echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Tümünü Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Tüm ayarları sıfırlamak istediğinizden emin misiniz?', 'csf' ) .'">' : '';
            echo '</div>';
        ...
        if ( ! empty( $this->args['show_footer'] ) ) {
          ...
          echo '<div class="csf-buttons">';
          echo '<input type="submit" name="csf_transient[save]" class="button button-primary csf-save'. esc_attr( $ajax_class ) .'" value="'. esc_html__( 'Kaydet', 'csf' ) .'" data-save="'. esc_html__( 'Kaydediliyor...', 'csf' ) .'">';
          echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Bölümü Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Bü bölümü sıfırlamak istediğinizden emin misiniz?', 'csf' ) .'">' : '';
          echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Tümünü Sıfırla', 'csf' ) .'" data-confirm="'. esc_html__( 'Bütün ayarları sıfırlamak istediğinizden emin misiniz?', 'csf' ) .'">' : '';
          echo '</div>';
